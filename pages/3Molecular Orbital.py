...
img_322 = img_b64("images/3.2.2.png")
img_331 = img_b64("images/3.3.1.png")
img_332 = img_b64("images/3.3.2.png")
...
.half-right{{display:grid;grid-template-columns:1fr 1fr;gap:2rem;align-items:start}}
  ...
  <div class="half-right">
    <div>
      ...
      <div class="formula-box">
        \( \Psi_\mathrm{{MO}} = c_A \psi_A + c_B \psi_B \)
...
<div class="section">
  ...
  <div class="half-right">
    ...
    <div class="img-card">
      ...
      <div class="img-caption">分子轨道对称性演示：σ/π/δ 型轨道的形成规律（以双原子分子 AB 为例）</div>
    </div>
  </div>
  ...
  <div class="half-right">
    ...
    <div class="img-card">
      <img src="{img_322}" alt="成键与反键轨道">
      <div class="img-caption">2p 轨道的 end-on 与 sideways 重叠：σ 和 π 型分子轨道的形成</div>
    </div>
  </div>
...
<!-- 3.3.1 能级图 -->
  ...
  <div class="half-right">
    ...
    <div class="img-card">
      <img src="{img_332}" alt="电子填充规则示意图">
      <div class="img-caption">分子轨道电子填充规则：Aufbau、泡利、洪特规则示意</div>
    </div>
  </div>
